...
\subsection{Horch-Schunck}\label{sec:horn-schunck}
The Horch-Schunck method is another global algorithm\citet{horn80}. It assumes that the flow in a frame is smooth and will minimize any error in this assumption.
