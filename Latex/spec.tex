...
seen in \autoref{fig:resolutions}.
...
\begin{figure}[htbp]
	\begin{tikzpicture}[scale=0.34]
		...
		\node() at (19.2,20.4){3840};
		\node() at (36.7,10.8){2160};
	\end{tikzpicture}
...
external computer interface. Thankfully, with the developmen of USB 3.0 we are able 
...
ethernet module allows the VISCA control commands from \autoref{sec:visca} to be transferred over the same 
