...
%% include if relevant
\glsaddall
\printglossary[title=Glossary and Terms, style=long]

%% include if relevant
\printglossary[title=List of Acronyms and Nomenclature,type=\acronymtype] % prints just the list of acronyms
\cleardoublepage
